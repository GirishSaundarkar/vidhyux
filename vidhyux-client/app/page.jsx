...
import { Users, Link, Download } from "lucide-react";
      ...
      <section className="py-24 px-6 lg:px-12 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center">
            <a
              href="/upload"
              className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-12 py-6 rounded-3xl text-xl font-bold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-3xl"
            >
